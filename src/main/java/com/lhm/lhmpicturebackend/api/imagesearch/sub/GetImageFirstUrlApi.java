...
public class GetImageFirstUrlApi {
    ...
    public static void main(String[] args) {
        // 请求目标 URL
        String url = "https://graph.baidu.com/s?card_key=&entrance=GENERAL&extUiData[isLogoShow]=1&f=all&isLogoShow=1&session_id=15890562793381531032&sign=12626e97cd54acd88139901736235709&tpl_from=pc\n";
